                                    ...
                                    >
                                        <div className='modal-container'>
                                            <div className='video-modal'>
                                                <video src={post.pUrl} autoPlay={true} muted="muted" controls />
                                            </div>
                                            <div className='comment-modal'>
                                                ...
                                                <Card variant="outlined" className='card2' >
                                                    ...
                                                    <div style={{display:'flex'}}>
                                                        <Like2 userData={userData} postData={post} userId={userId} style={{display:'flex', alignItems:'center', justifyContent:'center'}} />
                                                        <Addcomment userData={userData} postData={post} userId={userId}/>
                                                    </div>
                                                </Card>
                                            </div>
                                        </div>
